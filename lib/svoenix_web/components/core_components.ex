defmodule SvoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SvoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SvoenixWeb.Gettext, "errors", msg, opts)
    end
  end
